...
[Curation sites](#Curation-sites)  
[Tutorial papers](#Tutorial-papers)  
[Books](#Books)  
[Online courses](#MOOC-/-Online-Course)  
...
Framework for Open and Reproducible Research Training (FORRT). (n.d.). _Framework for Open and Reproducible Research Training (FORRT)._ https://forrt.org/  
...
Open Scholarship Knowledge Base. (n.d.). _Open Science Foundation._ https://www.oercommons.org/hubs/OSKB  
...
Rushworth, A. (n.d.). _Posts you might have missed!_ https://postsyoumighthavemissed.com/  
...
UK Reproducibility Network. (n.d.). _UK Reproducibility Network - Resources._ https://www.ukrn.org/resources/  
...
McIntyre, K. P. (2021). _Open Stats Lab_
https://sites.google.com/view/openstatslab/home  
...
Navarro, D. (2018, December 31). _Learning Statistics with R._ https://learningstatisticswithr-bookdown.netlify.com/  
...
McAleer, P. (2022, January 16). _A Handy Workbook for Research Methods & Statistics._ https://psyteachr.github.io/handyworkbook/  
...
McAleer, P., Kuepper-Tetzel, C., & Paterson, H. (2022, January 21). _PsyTeachR. Year 2 Research Methods and Statistics Practical Skills (1.0.9001)._ https://doi.org/10.5281/zenodo.5101080  
...
Nordmann, E. & Cleland-Woods, H. (2021, December 10). _PsyTeachR. Level 1 Data Skills (0.0.9)._ Zenodo. https://doi.org/10.5281/zenodo.3966961  
...
Nordmann, E. & McAleer, P. (2022, January 7). _PsyTeachR. Fundamentals of Quantitative Analysis._ https://psyteachr.github.io/quant-fun-v2/  
...
Bartlett, J.E. (2021, July 6). _Introduction to Power Analysis: A Guide to G*Power, jamovi, and Superpower_. https://osf.io/zqphw/  
...
Barr, D. (2021, November 10). _PsyTeachR. Level 3: Statistical Models._ https://psyteachr.github.io/stat-models-v1/  
...
BBC Visualisation cookbook. (2019, January 24). _BBC visualisation cookbook._ https://bbc.github.io/rcookbook/  

* Written for data journalists, this book walks through how to create data visualisations that balance aesthetics, clarity, and information.  

Debruine, L. & Barr, D. (2021, October 15). _PsyTeachR. Data Skills for Reproducible Research._ https://doi.org/10.5281/zenodo.3564555  
...
Mineault, P. & The Good Research Code Handbook Community. (2021). _The Good Research Code Handbook_. Zenodo. https://doi.org/10.5281/zenodo.5796873    
<!-- Zenodo link is the official citation, but from the Zenodo page it's difficult to find the actual URL. https://goodresearch.dev/index.html -->
...
Rougier, N.P. (2021). Scientific Visualization: Python + Matplotlib. 
...
### Beginner
Lakens, D. (n.d.). Improving your statistical inferences. Coursera. https://www.coursera.org/learn/statistical-inferences  
...
### Intermediate
McElreath, R. (2022). Statistical rethinking (2022 Edition). https://github.com/rmcelreath/stat_rethinking_2022  
...
Buchanan, E. (n.d.). Statistics of Doom [Youtube channel]. https://www.youtube.com/c/StatisticsofDOOM  

* This Youtube channel features statistics tutorials in R, Python, JASP, and SPSS.  

Christiansen, P. (n.d.). Statistics Guides with Dr Paul Christiansen [YouTube channel]. https://www.youtube.com/channel/UCpjsdW-snzkUAx0lvqTJ7WA/featured  
...
### Intermediate
jamovi (n.d.). _Resources by the community_. https://www.jamovi.org/community.html  
...
## Clubs
Clubs provide an informal setting to combine learning with a supportive community for early career researchers. Clubs can facilitate access to best practices in statistics and scientific methods in a more accessible format.  
...
Bartlett, J. E. (2021, October 6). Learning To Read Scientific Journal Articles. _James E. Bartlett._ https://bartlettje.github.io/2021-10-06-learning-to-read-scientific-journal-articles/  
...
Buchanan, E. (n.d.) _Dr. Erin Buchanan._ https://www.aggieerin.com/  
...
DeBruine, L. (n.d.). _Lisa Debruine._ https://debruine.github.io/#posts  
...
Magnusson, K. (n.d.). _R Psychologist._ https://rpsychologist.com/  
...
Rousselet, G. (n.d.). _Basic Statistics._ https://garstats.wordpress.com/  
...
Roye, D. (n.d.). _R visualization of spatial, geographical, and climate data._ https://dominicroye.github.io/en/  

* The author as a climate scientist writes tutorials on R visualization of geographical data. 

Scherer, C. (n.d.). _Data Visualization in R, Computational Ecology._ https://www.cedricscherer.com/  
...
Stefan, A. & Schönbrodt, F. (2018, November 14). Gazing into the Abyss of P-Hacking: HARKing vs. Optional Stopping. _Felix Schönbrodt._ https://www.nicebread.de/harking-optionalstopping/  
...
Schönbrodt, F. (2017, June 1). Correcting bias in meta-analyses: What not to do (meta-showdown Part 1). _Felix Schönbrodt._ https://www.nicebread.de/meta-showdown-1/  

* This blog post highlights common pitfalls in meta-analyses and makes recommendations on how to avoid and correct biases. 

Sleegers, W. (2021, 23 September). Simulation-based power analyses. _Willem Sleegers._ https://www.willemsleegers.com/posts/simulation-based-power-analyses/  
...
Wood, K. (2018, January 29). CORVIDS: A provably-complete data reconstruction tool. _Katherine Wood._
...
Wood, K. (2017, October 9). Pre-screen MTurk workers with custom qualifications. _Katherine Wood._
https://katherinemwood.github.io/post/qualifications/  
